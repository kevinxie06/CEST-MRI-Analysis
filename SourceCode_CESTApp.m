classdef SourceCode_CESTApp < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        SPM12Label                      matlab.ui.control.Label
        spm12FolderEditField            matlab.ui.control.EditField
        SelectSPM12FolderButton         matlab.ui.control.Button
    ...
    methods (Access = private)
        ...
        function clearHomePage(app)
            ...
            app.SPM12Label.Visible = 'off';
            app.spm12FolderEditField.Value = '';
            app.spm12FolderEditField.Visible = 'off';
            app.SelectSPM12FolderButton.Visible = 'off';
    ...
    methods (Access = private)
        ...
        function SelectDirectoryButtonPushed(app, event)
            try         
                ...
                % Make SPM12 directory step visible
                app.SPM12Label.Visible = 'on';
                app.spm12FolderEditField.Visible = 'on';
                app.SelectSPM12FolderButton.Visible = 'on';
        ...
        % Button pushed function: SelectSPM12FolderButton
        function SelectSPM12FolderButtonPushed(app, event)
           try
            spm_path = uigetdir;

            app.spm12FolderEditField.Value = spm_path;
        ...
        % Value changed function: spm12FolderEditField
        function spm12FolderEditFieldValueChanged(app, event)
            value = app.spm12FolderEditField.Value;
          ...
          if isempty(mprage_file)
             msgbox("Please select a file", 'Error', 'error');
              ...
              % try
                ...
                specialName = app.specialNameEditField.Value;
                spm12FilePath = app.spm12FolderEditField.Value;
    
                MPRAGE_mask_generate(path, MPRAGEfile, specialName, spm12FilePath);
                
                
                msgbox("MPRAGE Mask Complete","Success!");
                pause(1.5);        
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.Image.Position = [277 578 424 164];
            ...
            app.SelectDirectoryButton.Position = [401 466 173 61];
            ...
            app.YourDirectoryEditField.Position = [361 433 253 22];
            ...
            app.WelcomePleaseselectyourdirectoryLabel.Position = [322 529 330 42];
            ...
            app.specialNameEditField.FontSize = 14;
            app.specialNameEditField.Visible = 'off';
            app.specialNameEditField.Position = [361 189 253 22];
            ...
            app.PleaseEnteraSaveNameLabel.Visible = 'off';
            app.PleaseEnteraSaveNameLabel.Position = [385 225 205 25];
            ...
            app.ContinueButton.Visible = 'off';
            app.ContinueButton.Position = [424 103 126 54];
            ...
            app.ClickhereforinstructionsLabel.Position = [401 66 175 22];
            ...
            app.InstructionsButton1.Position = [436 7 99 53];
            app.InstructionsButton1.Text = 'Instructions';

            % Create SelectSPM12FolderButton
            app.SelectSPM12FolderButton = uibutton(app.HomeTab, 'push');
            app.SelectSPM12FolderButton.ButtonPushedFcn = createCallbackFcn(app, @SelectSPM12FolderButtonPushed, true);
            app.SelectSPM12FolderButton.BackgroundColor = [0.949 0.8706 1];
            app.SelectSPM12FolderButton.FontName = 'Times New Roman';
            app.SelectSPM12FolderButton.FontSize = 15;
            app.SelectSPM12FolderButton.Visible = 'off';
            app.SelectSPM12FolderButton.Position = [401 308 173 61];
            app.SelectSPM12FolderButton.Text = 'Select SPM 12 Folder';

            % Create spm12FolderEditField
            app.spm12FolderEditField = uieditfield(app.HomeTab, 'text');
            app.spm12FolderEditField.ValueChangedFcn = createCallbackFcn(app, @spm12FolderEditFieldValueChanged, true);
            app.spm12FolderEditField.FontName = 'Times New Roman';
            app.spm12FolderEditField.Visible = 'off';
            app.spm12FolderEditField.Position = [356 278 263 22];

            % Create SPM12Label
            app.SPM12Label = uilabel(app.HomeTab);
            app.SPM12Label.HorizontalAlignment = 'center';
            app.SPM12Label.FontName = 'Times New Roman';
            app.SPM12Label.FontSize = 20;
            app.SPM12Label.FontAngle = 'italic';
            app.SPM12Label.Visible = 'off';
            app.SPM12Label.Position = [322 367 330 42];
            app.SPM12Label.Text = 'Please select SPM 12 Folder';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = SourceCode_CESTApp
